...
def identity_block(input_tensor,kernel_size,filters,stage,block,use_bias=True,train_bn=True):
    ...
    x = Activation('relu')(x)
    x = Conv2D(nb_filter3, (1, 1), name=conv_name_base + '2c', use_bias=use_bias)(input_tensor)
...
def get_resnet(input_image,stage5=False,train_bn=True):
    ...
    x=Conv2D(64,(7,7),strides=(2,2),name='conv1',use_bias=True)
    ...
    C3= x = identity_block(x, 3, [128, 128, 512], stage=4, block='a', train_bn=train_bn)
